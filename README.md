...
![chrome_ext_jiagou](https://qiuxc.cn/assets/chrome_ext_jiagou.76cc4c31.png)
...
![chrome_ext_fehelper](https://qiuxc.cn/assets/chrome_ext_fehelper.b3ebbb88.png)
...
![chrome_ggbp_options](https://qiuxc.cn/assets/chrome_ggbp_options.68c3662b.png)
...
![chrome_ext_devtools](https://qiuxc.cn/assets/chrome_ext_devtools.18fefca9.png)
...
![chrome_ggbp_ts](https://qiuxc.cn/assets/chrome_ggbp_ts.cb55130c.png)

- `service_worker` 有一个专属的控制台，可以在那里查看打印信息

![chrome_ggbp_ts2](https://qiuxc.cn/assets/chrome_ggbp_ts2.d170f90d.png)

- `content_script` 直接在页面控制台查看信息

- `devtools` 在此页面打开F12进行调试 `chrome-extension://{扩展ID}/devtools/index.html`，扩展ID查看：

![chrome_ext_devtools_ts](https://qiuxc.cn/assets/chrome_ext_devtools_ts.2c9247f2.png)
